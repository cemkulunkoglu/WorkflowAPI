...
namespace WorkflowManagemetAPI.Services.Employees
{
    public class EmployeeService : IEmployeeService
    {
        ...
        private void EnsureNoCycle(int employeeId, int? newManagerId)
        {
            ...
            if (newManagerId.Value == employeeId)
                throw new Exception("Kullanıcı kendine yönetici olamaz.");
            ...
            {
                throw new Exception("Kullanıcının altındaki birini yönetici olarak atayamazsınız.");
            }
        }
